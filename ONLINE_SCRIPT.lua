...
for i, v in ipairs(t) do
---------------------------------------------
	if v.name == 'MAP' and v.value == 63566
	then MARKET()
---------------------------------------------
---------------------------------------------
...
---------------------------------------------
	...
	elseif v.name == 'MAP' and v.value == 68169
	then MISTFOREST()
---------------------------------------------
---------------------------------------------
---------------------------------------------
	...
	then PRIVILAGE()
	---------------------------------------------
	elseif v.name == 'MAP' and v.value == 63703
	then NINJAFACILITY()
---------------------------------------------
---------------------------------------------
---------------------------------------------
...
---------------------------------------------
	...
	then WESTPLAIN()
---------------------------------------------
	elseif v.name == 'MAP' and v.value == 63534
	then NORTHPLAIN()
---------------------------------------------
	elseif v.name == 'MAP' and v.value == 63535
...
---------------------------------------------
	...
	then KASUBA()
---------------------------------------------
	elseif v.name == 'MAP' and v.value == 63553
	then FORTRESS()
---------------------------------------------
...
---------------------------------------------
	...
	then WAREHOUSE()
---------------------------------------------
	elseif v.name == 'MAP' and v.value == 63560
	then FOG()
---------------------------------------------
	elseif v.name == 'MAP' and v.value == 63562
	then NECROSIS()
---------------------------------------------
	elseif v.name == 'MAP' and v.value == 63564
	then MOUNTAIN()
---------------------------------------------
	elseif v.name == 'MAP' and v.value == 63565
	then BLUEBEAR()
---------------------------------------------
	elseif v.name == 'MAP' and v.value == 63572
	then BACKOLDWOOD()
---------------------------------------------
	elseif v.name == 'MAP' and v.value == 63595
	then BACKORDO()
---------------------------------------------
...
---------------------------------------------
	...
	then ONIGIRIMID()
---------------------------------------------
	elseif v.name == 'MAP' and v.value == 63494
	then ONIGIRINEARTOP()
---------------------------------------------
...
---------------------------------------------
	...
	then CAVEWETLAND()
	---------------------------------------------
	elseif v.name == 'MAP' and v.value == 63490
	then CAVEHIGHWAY()
	---------------------------------------------
	...
	---------------------------------------------
	elseif v.name == 'MAP' and v.value == 63516
	then CAVEGIANT()
	---------------------------------------------
...
---------------------------------------------
	...
	---------------------------------------------
	elseif v.name == 'MAP' and v.value == 63527
	then CAVEBACKGNOME()
	---------------------------------------------
	elseif v.name == 'MAP' and v.value == 63494
...
---------------------------------------------
	...
	then CAVESEWERAGE()
	---------------------------------------------
	elseif v.name == 'MAP' and v.value == 63630
	then WARZONETWO()
---------------------------------------------
---------------------------------------------
---------------------------------------------
	elseif v.name == 'MAP' and v.value == 63753
	then WARZONEONE()
---------------------------------------------
---------------------------------------------
---------------------------------------------
	...
	then UNKNOWNISLAND()
---------------------------------------------
	elseif v.name == 'MAP' and v.value == 63558
	then UNEXPLORERISLAND()
---------------------------------------------
	elseif v.name == 'MAP' and v.value == 63576
	then FALLISLAND()
---------------------------------------------
---------------------------------------------
...
---------------------------------------------
	...
	then BR()
---------------------------------------------
	elseif v.name == 'MAP' and v.value == 63604
	then BR()
---------------------------------------------
	elseif v.name == 'MAP' and v.value == 63606
	then BR()
---------------------------------------------
---------------------------------------------
	elseif v.name == 'MAP' and v.value == 63283
	then GUILD()
---------------------------------------------
	elseif v.name == 'MAP' and v.value == 63304
	then PVP()
---------------------------------------------
	elseif v.name == 'MAP' and v.value == 63167
	then PVP()
---------------------------------------------
---------------------------------------------
	...
	then CAVECARLA()
---------------------------------------------
	elseif v.name == 'MAP' and v.value == 63701
...
for i, v in ipairs(t) do
----------------------------
	if v.name == 'MAP' and v.value == 63289
	then EVENTLABIRINENTRANCE()
---------------------------------------------
	elseif v.name == 'MAP' and v.value == 63291
	then EVENTLABIRINB()
---------------------------------------------
	elseif v.name == 'MAP' and v.value == 63293
	then EVENTLABIRINC()
---------------------------------------------
	elseif v.name == 'MAP' and v.value == 63292
	then EVENTLABIRIND()
---------------------------------------------
...
t = gg.getListItems()
for i, v in ipairs(t) do
	if v.name == 'UD'	then v.value = 5304
...
t = gg.getListItems()
for i, v in ipairs(t) do
	if v.name == 'UD'	then v.value = 5227
elseif v.name == 'LR'	then v.value = -3743
elseif v.name == 'GR'	then v.value = -414
elseif v.name == 'FC'	then v.value = -2801
end
end
gg.setValues(t)
end
...
elseif v.name == 'FC'	then v.value = 17654
end
end
gg.setValues(t)
end ---------------------------
